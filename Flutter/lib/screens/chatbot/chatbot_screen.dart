...
class _ChatbotScreenState extends State<ChatbotScreen> {
  ...
  // Cap history sent to the LLM to avoid blowing the context window
  ...
  static const List<Map<String, dynamic>> _suggestedQuestions = [
    {'question': 'What is a non-compete clause?',                           'icon': Icons.work_off_rounded},
    {'question': 'What should I check before signing a rental agreement?',  'icon': Icons.home_rounded},
    {'question': 'What are my rights as an employee?',                      'icon': Icons.badge_rounded},
    {'question': 'Explain what an NDA is and when it applies',              'icon': Icons.lock_outline_rounded},
    {'question': 'What is the difference between a void and voidable contract?', 'icon': Icons.gavel_rounded},
    {'question': 'What happens if one party breaches a contract?',          'icon': Icons.warning_amber_rounded},
  ];
  ...
  Future<void> _sendMessage(String text) async {
    ...
    try {
      // Build history from all messages except the one just added,
      // capped at _maxHistoryMessages to avoid overflowing the LLM context.
      final allPrevious = _messages.take(_messages.length - 1).toList();
      final history = allPrevious
          .skip((allPrevious.length - _maxHistoryMessages).clamp(0, allPrevious.length))
          .map((m) => m.toJson())
          .toList();
      ...
      child: Row(children: [
        ...
        Expanded(
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(children: [
              ...
              Text('Online · General legal guidance',
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            child: Row(children: [
              const Icon(Icons.language_rounded, color: AppColors.gold, size: 14),
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Center(
          child: Column(children: [
            ...
            Text('Ask Lex Anything', style: AppTextStyles.displayTitle)
        ...
        ...(_suggestedQuestions.asMap().entries.map((e) {
          ...
          return GestureDetector(
            onTap: () => _sendMessage(q['question'] as String),
            child: Container(
